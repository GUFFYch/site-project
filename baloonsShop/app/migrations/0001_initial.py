    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.FileField(blank=True, upload_to='')),
                ('price', models.IntegerField(verbose_name='Цена')),
                ('event', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.event', verbose_name='Связанный праздник')),
            ],
        ),
        migrations.CreateModel(
            name='SiteSettings',
            fields=[
                ...
                ('logoImage', models.ImageField(upload_to='app/static/images/', verbose_name='Логотип')),
                ('descriptionmImage', models.ImageField(upload_to='app/static/images/', verbose_name='Изображение в поле (О нас)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='app/static/images/CoruselImages/', verbose_name='Картинки в карусель')),
